                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries" style="width: 300px;">
                            <option value="vi" data-image="img/flag-vn2.png" data-imagecss='flag yt' data-title="Vietnamese">Tiếng Việt</option>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="p-price first-row">$999.99</td>
                                    ...
                                    <td class="total-price first-row">$999.99</td>
                                ...
                                <tr>
                                    ...
                                    <td class="total-price">$999.99</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            ...
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Subtotal <span>$2999.97</span></li>
                                    <li class="cart-total">Total <span>$2999.97</span></li>
                                </ul>
