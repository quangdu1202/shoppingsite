                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="register-formga">
                        ...
                        <form action="#">
                            ...
                            <div class="group-input">
                                <label for="cf-pass">Confirm Password <span style="color: red;">*</span></label>
                                <input type="password" name="" id="cf-pass">
                            </div>
                            <button type="submit" class="site-btn register-btn">Register</button>
                        </form>
                        <div class="switch-login">
                            <a href="login.html" class="or-login">Back to login</a>
                        </div>
                    </div>
                </div>
            </div>
